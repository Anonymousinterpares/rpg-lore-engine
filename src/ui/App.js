...
const App = () => {
    ...
    const [initialBookPage, setInitialBookPage] = useState(null);
    ...
    const openCodex = () => {
        setInitialBookPage({
            id: 'codex',
            label: 'Codex',
            content: _jsx(Codex, { isOpen: true, onClose: () => setBookOpen(false), isPage: true })
        });
        setBookOpen(true);
    };
    const openEquipment = () => {
