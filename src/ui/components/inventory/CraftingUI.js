...
const CraftingUI = ({ recipes, playerInventory, onCraft, onClose, className = '' }) => {
    ...
    return (_jsx("div", { className: `${styles.overlay} ${className}`, children: _jsxs("div", { className: `${styles.modal} ${parchmentStyles.panel}`, children: [_jsxs("div", { className: styles.header, children: [_jsxs("div", { className: styles.headerTitle, children: [_jsx(Hammer, { size: 24, className: styles.icon }), _jsx("h2", { className: parchmentStyles.heading, children: "Crafting Workshop" })] }), _jsx("button", { className: styles.closeButton, onClick: onClose, children: _jsx(X, { size: 20 }) })] }), _jsxs("div", { className: styles.content, children: [_jsxs("div", { className: styles.recipeList, children: [_jsx("h3", { className: styles.sectionTitle, children: "Recipes" }), _jsx("div", { className: styles.listContainer, children: recipes.map(recipe => (_jsxs("div", { className: `${styles.recipeItem} ${selectedRecipe?.id === recipe.id ? styles.selected : ''}`, onClick: () => setSelectedRecipe(recipe), children: [getTypeIcon(recipe.type), _jsxs("div", { className: styles.recipeInfo, children: [_jsx("span", { className: styles.recipeName, children: recipe.name }), _jsx("span", { className: styles.recipeType, children: recipe.type })] }), !canCraft(recipe) && _jsx("div", { className: styles.missingBadge, children: "Needs Materials" })] }, recipe.id))) })] }), _jsx("div", { className: styles.detailPane, children: selectedRecipe ? (_jsxs("div", { className: styles.recipeDetails, children: [_jsxs("div", { className: styles.detailHeader, children: [_jsx("h3", { className: parchmentStyles.heading, children: selectedRecipe.name }), _jsx("p", { className: styles.detailDesc, children: selectedRecipe.description })] }), _jsxs("div", { className: styles.requirements, children: [_jsx("h4", { children: "Required Materials" }), _jsx("div", { className: styles.ingredientList, children: selectedRecipe.ingredients.map(ing => {
                                                ...
                                                }) })] }), _jsxs("button", { className: `${styles.craftButton} ${parchmentStyles.button}`, disabled: !canCraft(selectedRecipe), onClick: () => onCraft(selectedRecipe.id), children: [_jsx(Hammer, { size: 18 }), "Start Crafting"] })] })) : (_jsxs("div", { className: styles.emptyDetail, children: [_jsx(Info, { size: 48, opacity: 0.2 }), _jsx("p", { children: "Select a recipe to view details" })] })) })] })] }) }));
};
