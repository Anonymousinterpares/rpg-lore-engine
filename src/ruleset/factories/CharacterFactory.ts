    ...
    public static createNewGameState(options: CharacterCreationOptions): GameState {
        ...
        return {
            ...
            worldMap: (() => {
                ...
                const { hex: startHex } = HexGenerator.generateHex([0, 0], [], emptySizes, pool, [], worldSeed);
                ...
                directions.forEach(dir => {
                    ...
                    const { hex: neighbor } = HexGenerator.generateHex(coords, [{ biome: 'Plains' }], emptySizes, pool, [], worldSeed);
