...
export class LoreService {
     ...
     */
    static async registerMonsterEncounter(monsterId, state, updateState) {
     ...
     */
    static async registerItemDiscovery(itemId, state, updateState) {
    ...
    static async generateLore(category, entityId, state, updateState) {
    ...
    static buildPrompt(category, name, data) {
