...
export class EngineDispatcher {
     ...
     */
    static dispatch(calls, state, hexManager, engines) {
            ...
            try {
                switch (call.function) {
                    ...
                    case 'modify_hp':
                        ...
                        state.character.hp.current = Math.min(state.character.hp.max, Math.max(0, state.character.hp.current + hpAmount));
                        break;
                    case 'add_item':
                    ...
                    case 'modify_gold':
                        ...
                        if (!state.character.inventory.gold)
                            state.character.inventory.gold = { cp: 0, sp: 0, ep: 0, gp: 0, pp: 0 };
                    ...
                    case 'skill_check':
                        ...
                        const skillResult = Dice.roll('1d20') + Math.floor(((state.character.stats[call.args.stat] || 10) - 10) / 2);
