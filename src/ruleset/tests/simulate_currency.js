...
function testCurrency() {
    ...
    const wallet = { cp: 10, sp: 5, ep: 0, gp: 2, pp: 0 };
    ...
    // Test Addition
    const loot = { cp: 0, sp: 0, ep: 5, gp: 1, pp: 0 }; // 1gp, 5ep = 1gp + 2.5gp? No, 5ep=2.5gp. 100+250 = 350
    ...
    // Test Subtraction
    const cost = { cp: 0, sp: 0, ep: 0, gp: 5, pp: 0 };
    ...
    const tooExpensive = { cp: 0, sp: 0, ep: 0, gp: 100, pp: 0 };
