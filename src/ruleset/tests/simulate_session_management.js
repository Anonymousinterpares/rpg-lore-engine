...
async function verifySessionManagement() {
    ...
    const priceN = ShopEngine.getBuyPrice({ cost: { cp: 0, sp: 0, ep: 0, gp: 10, pp: 0 }, weight: 2 }, npc);
    ...
    const priceF = ShopEngine.getBuyPrice({ cost: { cp: 0, sp: 0, ep: 0, gp: 10, pp: 0 }, weight: 2 }, npc);
