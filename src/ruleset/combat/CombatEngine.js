...
export class CombatEngine {
     ...
     */
    static resolveAttack(attacker, target, attackBonus, damageDice, damageBonus, advantage = 'none') {
        let d20 = Dice.d20();
        ...
        if (target.tactical.cover === 'Half')
            effectiveAC += 2;
        else if (target.tactical.cover === 'Three-Quarters')
            effectiveAC += 5;
