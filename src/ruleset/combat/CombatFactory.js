export class CombatFactory {
     ...
     */
    static fromMonster(monster, idOverride) {
        return {
            ...
            spellSlots: monster.spellcasting ? Object.fromEntries(Object.entries(monster.spellcasting.slots).map(([lv, data]) => [lv, { current: data.count, max: data.count }])) : undefined,
     ...
     */
    static fromPlayer(pc, idOverride) {
        return {
