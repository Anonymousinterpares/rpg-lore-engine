...
export const StandardActions = {
     ...
     */
    attack: (attacker: CombatantState, target: CombatantState, bonus: number, damage: string, dmgBonus: number, isRanged: boolean = false) => {
     ...
     * Grapple Action
     */
    grapple: (attacker: CombatantState, target: CombatantState, attackerAthletics: number, targetAthleticsOrAcrobatics: number) => {
        if (attacker.resources.actionSpent) return 'Action already spent.';
     ...
     * Shove Action
     */
    shove: (attacker: CombatantState, target: CombatantState, attackerAthletics: number, targetAthleticsOrAcrobatics: number, type: 'prone' | 'push') => {
        if (attacker.resources.actionSpent) return 'Action already spent.';
     ...
     */
    twoWeaponAttack: (attacker: CombatantState, target: CombatantState, bonus: number, damage: string) => {
        if (attacker.resources.bonusActionSpent) return 'Bonus Action already spent.';
     ...
     */
    opportunityAttack: (attacker: CombatantState, target: CombatantState, bonus: number, damage: string, dmgBonus: number) => {
        if (attacker.resources.reactionSpent) return 'Reaction already spent.';
